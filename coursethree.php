        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Course 3</h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Repeater Achievers Program</h1>
                    <p class="mb-4"> This course is specifically designed for students who have already appeared for the exam once and are seeking to enhance their scores by focusing on their weak areas and building a stronger foundation.</p>
                    ...
                    <div class="row gy-2 gx-4 mb-4">
                        ...
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>For : Students appearing for JEE after finishing Standard 12th</p>
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4"> Our course employs a comprehensive teaching methodology to cater to the specific needs of repeater students. Our experienced faculty members utilize a combination of lectures, interactive discussions, and problem-solving sessions to facilitate a deep understanding of concepts and their application. Regular practice tests, mock exams, and analysis of previous years' question papers are incorporated to provide students with a realistic exam experience and identify areas that require improvement. Personalized doubt-solving sessions and one-on-one guidance are also provided to address individual queries and concerns.
                    </p>
                    <h1 class="mb-4">Additional Support</h1>
                    <p class="mb-4"> In addition to the core subjects, our course offers additional support to repeater students. We provide guidance on time management, exam strategies, and effective revision techniques to help students optimize their study plans and maximize their scores. Motivational sessions and counseling are also conducted to support students' emotional well-being and boost their confidence levels.
                    </p>
                    <p class="mb-4"> By enrolling in our JEE Physics, Chemistry, and Mathematics course for repeater students, you will receive targeted and comprehensive preparation to improve your JEE scores. Our goal is to help you strengthen your conceptual understanding, enhance problem-solving skills, and boost your confidence to excel in the JEE Advanced and JEE Main examinations.</p>
                    <div class="row gy-2 gx-4 mb-4">
