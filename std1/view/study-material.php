						...
						<div class="box-body">
                			<div class="form-group" id="divName">
                    			<label for="">Class Name</label>
                      			<input type="text" class="form-control" id="name" placeholder="Enter class" name="Class" autocomplete="off">                    
                    		</div>
                    		<div class="form-group" id="divStudentCount">
                      			<label for="">Course Name</label>
                      			<input type="text" class="form-control" id="student_count" placeholder="Enter Course" name="Course"  autocomplete="off">
                    		</div>
                    		<div class="form-group" id="divStudentCount">
                      			<label for="">Subject Name</label>
                      			<input type="text" class="form-control" id="student_count" placeholder="Enter Subject" name="Subject"  autocomplete="off">
                    		</div>
                    		<div class="form-group" id="divStudentCount">
                      			<label for="">Study Material File</label>
                      			<input type="file" class="form-control" id="student_count" name="Study-Material"  autocomplete="off">
                    		</div>
                		</div><!-- /.box-body -->
        	...
        	<div class="col-md-8">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">All Study Material</h3>
                	</div><!-- /.box-header -->
