        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Join Our Courses</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Join oriJEEn Courses</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">Join oriJEEn premium courses and get access to all facilities of oriJEEn.</p>
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">3/17, Prafulla Chakki Path, City Centre, Durgapur, W.B., 713216</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">89186 52513 / 89065 40698</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">orijeenacademy@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d18433.321652014936!2d87.27814901522963!3d23.545648516016907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f7716d9aecdbb9%3A0x40bab308e70706f8!2soriJEEn%20(%20A%20Balram%20Mishra%20Initiative)!5e0!3m2!1sen!2sin!4v1693581347372!5m2!1sen!2sin"
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="subject" placeholder="Subject" required>
                                    <label for="subject">Your Class</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit">Join Now</button>
                            </div>
                        </div>
                    </form>
                </div>
