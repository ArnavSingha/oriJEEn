        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Course Two</h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Advanced Achievers</h1>
                    <p class="mb-4"> A specialized course for high-performing students aiming for top ranks in JEE Mains & Advanced, providing advanced level coaching and extensive practice.</p>
                    <p class="mb-4"> Introducing our Advanced Achievers Program Course specifically designed to prepare students for the JEE (Joint Entrance Examination) at the highest level. This comprehensive course aims to provide students with an in-depth understanding of key concepts, problem-solving skills, and exam strategies necessary to excel in the competitive JEE examinations.</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                     <!-- Service Start -->
                        <div class="container-xxl py-5">
                            <div class="container">
                                <div class="col">
                                    <div class="row-lg-3 row-sm-6 wow fadeInUp"  data-wow-delay="0.1s">
                                        <div class="service-item text-center pt-3">
                                            <div class="p-4">
                                                <h5 class="mb-3">Comprehensive Syllabus Coverage</h5>
                                                <p>The course covers the entire JEE syllabus, ensuring that students are well-prepared for all topics and question types that may appear in the exam. We focus on building a strong conceptual foundation and clarity in fundamental principles.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row-lg-3 row-sm-6 wow fadeInUp" style="margin-top: 10px;" data-wow-delay="0.3s">
                                        <div class="service-item text-center pt-3">
                                            <div class="p-4">
                                                <h5 class="mb-3">Experienced Faculty</h5>
                                                <p>Our faculty members are highly experienced and specialize in their respective subjects. They possess a deep understanding of JEE-level concepts and have a proven track record of helping students achieve exceptional results.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row-lg-3 row-sm-6 wow fadeInUp" style="margin-top: 10px;" data-wow-delay="0.5s">
                                        <div class="service-item text-center pt-3">
                                            <div class="p-4">
                                                <h5 class="mb-3">Problem-Solving Strategies
                                                </h5>
                                                <p>We emphasize problem-solving techniques and strategies specific to JEE-level exams. Students will learn how to approach complex problems, employ logical reasoning, and optimize their time management skills during the exam.

                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row-lg-3 row-sm-6 wow fadeInUp" style="margin-top: 10px;" data-wow-delay="0.7s">
                                        <div class="service-item text-center pt-3">
                                            <div class="p-4">
                                                <h5 class="mb-3">Regular Practice and Assessments</h5>
                                                <p>To reinforce learning, regular practice sessions and assessments are conducted. This helps students evaluate their progress, identify areas of improvement, and build confidence in tackling exam-level questions.
